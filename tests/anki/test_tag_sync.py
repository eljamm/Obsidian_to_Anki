...
test_file_paths = [
    "tests/test_outputs/{}/Obsidian/{}/{}.file.md".format(
        test_name, test_name, test_name
    ),
    "tests/test_outputs/{}/Obsidian/{}/{}.md".format(test_name, test_name, test_name),
    "tests/test_outputs/{}/Obsidian/{}/{}.file.inline.md".format(
        test_name, test_name, test_name
    ),
]
...
def test_cards_front_back_tag_type(col: Collection):
    ...
    note2 = find_note_with_1st_field(
        "This is a test. This should not have any tags except default ones.<br />\nAnd the test is continuing.",
        anki_IDs,
        col,
    )
    ...
    note3 = find_note_with_1st_field(
        "This is a test. this should have meow-tag<br />\nAnd the test is continuing. ",
        anki_IDs,
        col,
    )
    ...
    note4 = find_note_with_1st_field(
        "This is a test with file tags specified in new line", anki_IDs, col
    )
    ...
    note5 = find_note_with_1st_field(
        "This is a test 2 with file tags specified in new line<br />\nAnd the test is continuing.",
        anki_IDs,
        col,
    )
    ...
    note6 = find_note_with_1st_field(
        "This is a test with file tags specified inline", anki_IDs, col
    )
    ...
    note7 = find_note_with_1st_field(
        "This is a test 2 with file tags specified inline<br />\nAnd the test is continuing.",
        anki_IDs,
        col,
    )
