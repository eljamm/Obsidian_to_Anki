...
def test_cards_front_back_tag_type(col: Collection):
    ...
    assert note1.fields[0] == "This is how to use"
    assert note1.fields[1] == "Remnote single-line style"

    note2 = col.get_note(anki_IDs[1])
    assert note2.fields[0] == "You can have"
    assert note2.fields[1] == "multiple notes in the same file"
