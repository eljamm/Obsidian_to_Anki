...
test_file_paths = [
    ...
    [
        "tests/test_outputs/{}/Obsidian/{}/English/No Deck/{}.parent.md".format(
            test_name, test_name, test_name
        ),
        "English",
    ],
    [
        "tests/test_outputs/{}/Obsidian/{}/Math meow/{}.math.md".format(
            test_name, test_name, test_name
        ),
        "Math",
    ],
    [
        "tests/test_outputs/{}/Obsidian/{}/Science meow/{}.science.md".format(
            test_name, test_name, test_name
        ),
        "Science",
    ],
