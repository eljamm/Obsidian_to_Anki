...
test_file_paths = [
    "tests/test_outputs/{}/Obsidian/{}/scan_dir/{}.md".format(
        test_name, test_name, test_name
    ),
    "tests/test_outputs/{}/Obsidian/{}/scan_dir/also_scan/folder_scan_subdir.md".format(
        test_name, test_name
    ),
]

test_file_no_cards_paths = [
    "tests/test_outputs/{}/Obsidian/{}/should_not_scan_dir/should_not_scan.md".format(
        test_name, test_name
    ),
